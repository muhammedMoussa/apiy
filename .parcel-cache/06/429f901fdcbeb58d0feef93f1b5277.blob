...
}).then(res => console.log(res)).catch(err => console.error(err)); // console.log(apiy.get());
...
const Get = options => {
  const req = new Promise(async (resolve, reject) => {
    ...
    xhr.onload = async () => await (0, _utils.onloadHandler)(xhr);
...
},{"./handlers/onloadHandler":"018b13b2f35cf5967605c88fcac00c18"}],"018b13b2f35cf5967605c88fcac00c18":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=app.63ebbeca.js.map
