...
const Get = options => {
  const req = new Promise(async (resolve, reject) => {
    ...
    xhr.responseType = (0, _utils.responseTypeHandler)(options.responseType);
...
const responseTypeHandler = responseType => responseType || 'json';
...
//# sourceMappingURL=app.19258883.js.map
