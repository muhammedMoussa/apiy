...
var _methods = require("./core/methods");

/* main apiy entry */
class Apiy {
  get(opt) {
    return (0, _methods.Get)({
      method: 'GET',
      ...opt
    });
  }
...
exports.Apiy = Apiy;
const apiy = new Apiy();
apiy.get().then(res => console.log(res)).catch(err => console.error(err));
},{"./core/methods":"4a7f95fa5a9c19cce29de8c632df12ed"}],"4a7f95fa5a9c19cce29de8c632df12ed":[function(require,module,exports) {
"use strict";
...
},{"./Get":"78677fdb79b7c77ef5bf9b92a0ed4878"}],"78677fdb79b7c77ef5bf9b92a0ed4878":[function(require,module,exports) {
"use strict";
...
const Get = options => {
  const req = new Promise(async (resolve, reject) => {
    ...
    xhr.withCredentials = true; // @TODO: UTIL THIS TO READ FROM options
...
},{"./handlers/onloadHandler":"018b13b2f35cf5967605c88fcac00c18","./validators/optionsValidator":"e5c653245e2b05fdcaed457ff9834f80"}],"018b13b2f35cf5967605c88fcac00c18":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=app.b74090b1.js.map
